...
public class Menu {
    ...
    *   v1.0
    */
    public void display(Scanner sc, User myUser , ArrayList<User> userlist ) {     
        while (this.isMenu_continu()  == true){
            ...
            switch (choix)
            {
                ...
                case 3:
                    Message.writeMessage(myUser ,sc);
                    break;
                    
                case 4:
                    Message.afficheMessage(myUser ,sc);
                    break;
                    
                    
                case 5:
                    myUser.createFriend( sc , userlist) ;
                    break;

                case 6:
                    myUser.afficheUnAmi(sc );
                    break;
