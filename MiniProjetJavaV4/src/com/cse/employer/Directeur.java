...
public class Directeur extends Employe implements Relation {
    public Directeur(String nomUser,String prenomUser ,String dateNaissanceUser) {
        this.nom = nomUser;
        this.prenom = prenomUser;
        this.dateNaissance = dateNaissanceUser;
    }
    public static Directeur createDir( Scanner enter ,ArrayList<Personne> listStaff){
        ...
        Directeur myUser = new Directeur(nomUser,prenomUser,dateNaissanceUser);
